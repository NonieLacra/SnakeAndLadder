...
class FourPlayerMenu : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_player4, container, false)
        ...
        val player4Name : EditText = view.findViewById(R.id.player4_field)
        ...
        playGameBtn.setOnClickListener(){
            ...
            editor.putString("Player 4", player4Name.text.toString())
            editor.apply()

            val fragment = FourPlayerGame()
            val bundle = Bundle()
            ...
            bundle.putString("Player 4", player4Name.text.toString())
